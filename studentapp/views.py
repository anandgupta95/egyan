...
#apply decorator to validate through server instead of browser because browser store the previous session data
...
def studenthome(request):
    try:
        if request.session['rollno']!=None:
            ...
            sub = Material.objects.filter(program=stu.program,branch=stu.branch,year=stu.year,materialtype='smat')
